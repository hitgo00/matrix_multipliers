...
#include<stdlib.h>
#include<cuda.h>
#define SZ 8192 //Recommended uptil 8192 for "current gpu" because strassen gives inaccurate results because of numerical instability and also of its memory boundedness.
#define L 2048
#define T 32
#define R 1
